        ...
        if 't.me/c/' in msg_link or 't.me/b/' in msg_link:
            ...
            if chat in saved_channel_ids:
                await app.edit_message_text(
                    ...
                    "Sorry! This channel is protected by **__UIO__**."
                )
                return
...
get_user_rename_preference = lambda user_id: user_rename_preferences.get(str(user_id), 'UIO')
...
async def send_settings_message(chat_id, user_id):
    ...
    buttons = [
        ...
        [Button.url("Report Errors", "https://t.me/UIHASH")]
    ]
...
async def callback_query_handler(event):
    ...
    if event.data == b'setchat':
        ...
        await event.respond("Watermark is Pro+ Plan.. contact @UIHASH")
        return
        ...
        buttons = [
            ...
            [Button.inline(f"UIO v1 ⚡{telethon_check}", b'telethon')]
        ]
        await event.edit("Choose your preferred upload method:\n\n__**Note:** **UIO ⚡**, built on Telethon(base), by UIO still in beta.__", buttons=buttons)
    ...
    try:
        ...
        if freecheck == 1:
            reply_markup = InlineKeyboardMarkup(
                [
                    [InlineKeyboardButton("💎 Get Premium to Forward", url="https://t.me/UIHASH")]
                ]
            )
