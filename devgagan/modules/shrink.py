...
async def token_handler(client, message):
    ...
    if len(message.command) <= 1:
        image_url = "https://envs.sh/ajv.jpg"
        join_button = InlineKeyboardButton("Join Channel", url="https://t.me/UIHASH")
        premium = InlineKeyboardButton("Get Premium", url="https://t.me/UIHASH")   
        ...
        await message.reply_photo(
            msg.photo.file_id,
            caption=(
                "Hi 👋 **{message.from_user.mention}** Welcome, Wanna intro...?\n\n"
